...
// ═══════════════════════════════════════════════════════════════════
// 🧠 FEATURE D: Brain Directory (Knowledge Items)
// ═══════════════════════════════════════════════════════════════════
...
impl AgentTool for DistillKnowledgeTool {
    ...
    fn description(&self) -> &'static str { "After completing a significant task, write a distilled 1-paragraph summary to your brain for future reference. This creates a persistent knowledge item in ~/.tempest/brain/ that you will remember across sessions." }
    fn is_modifying(&self) -> bool { true }
    fn parameters(&self) -> Value {
        serde_json::json!({
            "type": "object",
